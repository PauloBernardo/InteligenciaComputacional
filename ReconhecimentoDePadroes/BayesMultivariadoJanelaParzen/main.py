...
from ReconhecimentoDePadroes.BayesMultivariadoJanelaParzen.basic import run_test
from ReconhecimentoDePadroes.BayesMultivariadoJanelaParzen.bayesDiscriminantJanelaParzen import BayesDiscriminantJanelaParzenClassifier
